...
namespace Phrase
{
    ...
    public class ConfigFileOptions : DialogPage
    {
        ...
        [Description("Generate a Phrase API Access Token in your Account")]
        ...
        [Description("The ID of your Phrase Project")]
        ...
        protected override void OnApply(PageApplyEventArgs e)
        {
            ...
            {
                if (MessageBox.Show(".phraseapp.yml configuration already exists, overwrite?", "Phrase", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
    ...
    public class CliToolOptions : DialogPage
    {
        ...
        [Description("Full Path to the Phrase CLI tool")]
