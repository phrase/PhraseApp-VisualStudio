//------------------------------------------------------------------------------
// <copyright file="PushCommand.cs" company="Company">
...
namespace Phrase
{
    ...
    internal sealed class PushCommand
    {
        ...
        private PushCommand(Package package)
        {
        ...
        {
            Instance = new PushCommand(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("It looks like no project is open. Please open a project to push translation files");
                return;
            }
